...
if __name__ == "__main__":
    if len(sys.argv) != 4:
        print("Usage: python3 xmDMZ_LAN.py <test_ID> <mac_address> <webserver_ip>")
        sys.exit(1)
    ...
    sniff(filter="tcp dst port {}".format(ssh_port), prn=lambda x: packet_handler(x, target_ip, ssh_port), store=0, timeout=70)
    print("packet capture completed")
